...
asgd_unit: asgd_errors.o asgd.o tests/asgd_unit.c
	$(CC) $(CFLAGS) $(DEBUG) $(INCDIRS) $(LIBDIRS) $(LIBS) $(DEFS) -o bin/asgd_unit $(OBJS) asgd_errors.o asgd.o tests/asgd_unit.c
...
asgd_errors.o: asgd_errors.c asgd_errors.h
	$(CC) $(CFLAGS) $(DEBUG) $(INCDIRS) $(LIBDIRS) $(LIBS) $(DEFS) -c -o asgd_errors.o $(OBJS) asgd_errors.c
